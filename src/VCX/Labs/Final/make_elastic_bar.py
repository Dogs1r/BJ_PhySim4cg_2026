...
def parse_args():
    ...
    parser.add_argument("--nx", type=int, default=50, help="长方条 x 方向粒子数")
    parser.add_argument("--ny", type=int, default=20, help="长方条 y 方向粒子数")
    parser.add_argument("--nz", type=int, default=20, help="长方条 z 方向粒子数")
    ...
    parser.add_argument("--youngs", type=float, default=8.0e3, help="杨氏模量")
